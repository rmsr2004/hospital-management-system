...
VALUES
    (10000.00, '2020-01-01', NULL, 1, 123456789, 'Carlos Mendes', 'Viseu', '123456789', 'carlos', 'senha123', 'carlos@email.com', 2),
    (9000.00, '2019-05-15', NULL, 1, 987654321, 'Ana Silva', 'Coimbra', '987654321', 'ana', 'senha456', 'ana@email.com', 2),
    (9500.00, '2020-03-10', NULL, 1, 456789123, 'Ricardo Oliveira', 'Lisboa', '456789123', 'ricardo', 'senha789', 'ricardo@email.com', 2),
    (8500.00, '2018-09-20', NULL, 1, 789123456, 'Marta Santos', 'Porto', '789123456', 'marta', 'senha1011', 'marta@email.com', 2),
    (8800.00, '2019-12-05', NULL, 1, 234567891, 'José Ferreira', 'Braga', '234567891', 'jose', 'senha1213', 'jose@email.com', 2),
    (9200.00, '2019-08-10', NULL, 1, 678912345, 'Sofia Almeida', 'Viseu', '678912345', 'sofia', 'senha1415', 'sofia@email.com', 2),
    (8700.00, '2020-04-25', NULL, 1, 345678912, 'Tiago Martins', 'Coimbra', '345678912', 'tiago', 'senha1617', 'tiago@email.com', 2),
    (9200.00, '2018-11-15', NULL, 1, 891234567, 'Manuel Pereira', 'Faro', '891234567', 'manuel', 'senha1819', 'manuel@email.com', 2),
	(10000.00, '2020-01-02', NULL, 1, 123436789, 'Carlos Meneses', 'Vila Real', '123356789', 'carlosm', 'senha223', 'carlosm@email.com', 2),
    (9000.00, '2019-05-16', NULL, 1, 987653321, 'Ana Carla', 'Aveiro', '987654324', 'anac', 'senha426', 'anac@email.com', 2);
...
INSERT INTO employees (salary, start_date, final_date, ctype_id, person_cc, person_name, person_address, person_phone, person_username, person_password, person_email, person_type)
VALUES
    (3500.00, '2019-03-20', NULL, 2, 111222333, 'Maria Oliveira', 'Castelo Branco', '111222333', 'maria', 'senha21', 'maria@email.com', 3),
    (3400.00, '2020-02-10', NULL, 2, 444555666, 'Joana Santos', 'Santarem', '444555666', 'joana', 'senha22', 'joana@email.com', 3),
    (3600.00, '2018-08-15', NULL, 2, 777888999, 'Ana Costa', 'Beja', '777888999', 'ana_c', 'senha23', 'ana_c@email.com', 3);
...
INSERT INTO employees (salary, start_date, final_date, ctype_id, person_cc, person_name, person_address, person_phone, person_username, person_password, person_email, person_type)
VALUES
    (2000.00, '2017-12-01', NULL, 2, 999888777, 'Pedro Rodrigues', 'Coimbra', '999888777', 'pedro', 'senha24', 'pedro@email.com', 4),
	(3000.00, '2017-12-02', NULL, 2, 999888277, 'Rodrigo Rodrigues', 'Viseu', '999882777', 'rodrigo', 'senha25', 'rrodrigues@email.com', 4);
...
VALUES
    (123456789, 'João Silva', 'Viana do Castelo', '111222333', 'joao', 'senha123', 'joao@email.com', 1),
    (987654321, 'Ana Sousa', 'Leiria', '444555666', 'ana', 'senha456', 'ana@email.com', 1),
    (456789123, 'Carlos Santos', 'Lisboa', '777888999', 'carlos', 'senha789', 'carlos@email.com', 1),
    (789123456, 'Marta Ferreira', 'Santarem', '101112131', 'marta', 'senha1011', 'marta@email.com', 1),
    (234567891, 'Pedro Almeida', 'Viseu', '314151617', 'pedro', 'senha1213', 'pedro@email.com', 1),
    (678912345, 'Sofia Costa', 'Aveiro', '181920212', 'sofia', 'senha1415', 'sofia@email.com', 1),
    (345678912, 'Rita Oliveira', 'Coimbra', '222324252', 'rita', 'senha1617', 'rita@email.com', 1),
    (891234567, 'Hugo Martins', 'Beja', '262728293', 'hugo', 'senha1819', 'hugo@email.com', 1);
